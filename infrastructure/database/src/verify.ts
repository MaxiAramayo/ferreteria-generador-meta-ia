...
const latestMigrationName = "20260728010000_publication_state_history";
...
async function verifyDatabase(): Promise<void> {
  ...
  try {
    ...
    try {
      ...
      const removedTables = await testPool.query<{
        ...
        `
          SELECT
            ...
            to_regclass('public.publication_state_transitions')::text AS "history_table"
        `,
      );
      ...
      assert.equal(rollbackEvidence.history_table, null);
