...
export const CATALOG_STATUS: Readonly<Record<LayoutId, CatalogStatus>> =
  Object.freeze({
    ...
    "foto-producto-cartel": "current",
    "foto-producto-ficha": "current",
    "foto-producto-gondola-derecha": "current",
    "foto-producto-gondola-izquierda": "current",
    "foto-producto-libre": "current",
    "foto-producto-precio-grande": "current",
    "foto-producto-vidriera": "current",
